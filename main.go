...
func renderRecipeCard(r Recipe) string {
	...
	return `<a href="/recipes/` + strconv.Itoa(r.ID) + `" id="recipe-` + strconv.Itoa(r.ID) + `" class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow cursor-pointer flex flex-col">` +
		image +
